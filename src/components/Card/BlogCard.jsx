...
const BlogCard = () => {
  return (
    <div className="max-w-sm rounded-xl overflow-hidden shadow-md mt-2 border border-zinc-700">
      <Link to={'/blog/react-custom-hooks-useDarkSide'}>
        <img
          src="/img/blog-1-banner.webp"
          alt="use-dark-side"
          className="w-full scale-100 hover:scale-105 transition duration-500"
        />
      </Link>
      <div className="px-6 py-4">
        <Link to={'/blog/react-custom-hooks-useDarkSide'} className="font-semibold text-xl">
